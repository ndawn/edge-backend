# Generated by Django 2.1.5 on 2019-01-06 18:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='Создан')),
                ('updated', models.DateTimeField(auto_now=True, verbose_name='Обновлен')),
                ('cart', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='commerce.Cart', verbose_name='Корзина')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('load_monthly', models.BooleanField(blank=True, default=True, verbose_name='Месячный')),
                ('load_weekly', models.BooleanField(blank=True, default=True, verbose_name='Недельный')),
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='commerce.Category', verbose_name='Категория')),
            ],
            options={
